...
export const PROBABILISTIC_FEATURES = [
    ...
    "dermatomal", "generalizado", "localizado", "acral", "fotoexpuesto", "topo_flexural_pliegues", "topo_friccion_extensora",
    "agudo", "subagudo", "cronico", "prurito", "prurito_nocturno", "ardor_quemazon", "dolor", "asintomatico", "fiebre",
    "farmacos_recientes", "inmunosupresion", "diabetes", "hepatopatia", "atopia", "embarazo", "contagio_familiar",
    "eritema", "hiperpigmentacion", "hipopigmentacion", "costra", "erosion", "excoriacion",
    "liquenificacion", "nodulo", "quiste", "induracion", "telangiectasias", "atrofia", "habon", "comedon", "surco", "fistulas_supuracion",
...
// 2. Características Adicionales (Lógica Heurística y Reglas Cardinales)
const EXTRA_CLINICAL_FEATURES = [
    'sexo_male', 'sexo_female',
    'macula', 'mancha', 'tumor', 'vegetacion',
    'escara', 'fisura', 'esclerosis', 'cicatriz',
    'cabeza', 'cara_centro', 'tronco', 'extremidad_superior', 'extremidad_inferior', 'pies',
    'seborreica', 'simetrico', 'lineal',
    'escama_nacarada', 'escama_untuosa',
    'ampolla_nikolsky', 'signo_abcde',
    'lesion_evanescente', 'curacion_central',
    'umbilicacion', 'cupuliforme', 'color_violaceo',
    'mucosas' // Depurado de humo clínico obsoleto
];
