...
class ConceptMapper {
    ...
    resolve(inputId) {
        ...
        const coreAliases = {
            ...
            'necrosis_isquemia': 'necrosis_isquemia',
            'signo_hipotension': 'signo_hipotension',
            'compromiso_conciencia': 'compromiso_conciencia',
            'abcde_asimetria': 'signo_abcde',
            'abcde_bordes': 'signo_abcde',
            'abcde_color': 'signo_abcde',
            'abcde_diametro': 'signo_abcde',
            'abcde_evolucion': 'signo_abcde',
            'erythema': 'eritema',
            'scale': 'escama',
            'crust': 'costra',
            'ulcer': 'ulcera',
